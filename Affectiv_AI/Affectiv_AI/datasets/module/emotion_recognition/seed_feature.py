...
from ...functional.emotion_recognition.seed_feature import seed_feature_constructor
...
class SEEDFeatureDataset(BaseDataset):
    ...
    In order to use this dataset, the download folder :obj:`ExtractedFeatures` is required, containing the following files:
