...
class Select(LabelTransform):
    r'''
     ...
     The information dictionary in different dataset is different, if you want to rewrite this library, please check the .py file in datasets.functional.emotion_recognition.(seed/deap/...) transform_producer
    .. code-block:: python

         transform = Select(key='emotion')
         transform(y={'emotion': 1, 'subject_id': 7})['y']
         >>> 1
